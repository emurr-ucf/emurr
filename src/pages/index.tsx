        ...
        <div className="flex justify-between mt-5">
          <div className="flex flex-col">
            <div className="w-3/5 text-2xl font-light text-justify">
              The Exhibit Marker Uniform Resource Router (EMURR) aims to bridge the gap between digital infrastructure and interpretive information in public spaces. Through our extensive tour site builder you can create the best tour for any
              situation. Download onto the EMURR unit hardware and you&apos;re ready to go anywhere.
            </div>
            <div className="w-3/5 text-xl text-center font-bold mt-1">Get started by logging in and accessing your dashboard at the top right of the page.</div>
          </div>
        ...
        <div className="flex flex-col justify-between mt-5">
          ...
          <div className="flex justify-center my-10 gap-2 w-full">
            <div className="flex flex-col items-center w-52">
              ...
              <div className="text-center font-light text-gray-800">Lead Sponsor. UCF CHDR Associate Director.</div>
            </div>
            <div className="flex flex-col items-center w-52">
          ...
          <div className="flex justify-center my-10 gap-10">
            <div className="flex flex-col items-center w-52">
              ...
              <div className="text-center font-light text-gray-800">Project Manager</div>
            </div>
            <div className="flex flex-col items-center w-52">
              <img src={`${urlLocalPath}/images/team/edelis.jpg`} alt="EMURR-Logo" className="max-w-40 max-h-40 rounded-full shadow-md shadow-black object-cover" />
              <div className="text-center font-semibold">Edelis Molina Rios</div>
          ...
          <div className="flex justify-center my-10 gap-10">
            <div className="flex flex-col items-center w-52">
              <img src={`${urlLocalPath}/images/team/tye.png`} alt="EMURR-Logo" className="max-w-40 max-h-40 rounded-full shadow-md shadow-black" />
              <div className="text-center font-semibold">Robert “Tye” Riley</div>
              <div className="text-center font-light text-gray-800">Full Stack Developer</div>
            </div>
            <div className="flex flex-col items-center w-52">
              <img src={`${urlLocalPath}/images/team/gian.png`} alt="EMURR-Logo" className="max-w-40 max-h-40 rounded-full shadow-md shadow-black" />
              <div className="text-center font-semibold">Gian Alvarez Rujel</div>
              <div className="text-center font-light text-gray-800">Backend Developer</div>
            </div>
          </div>
        </div>
      </div>
