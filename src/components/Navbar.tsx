    ...
    <>
      <nav className="sticky top-0 z-50 w-full border-b border-brown backdrop-blur-md">
        <div className="flex justify-between h-auto w-full py-2 px-10">
          ...
          <div className="flex flex-row justify-center items-center text-xl text-brown">
            <div className={`p-2 rounded-md ${props.page === "home" ? "font-semibold hover:font-semibold" : ""} hover:bg-background-600 transition ease-in-out delay-50`}>
              <Link href="/">
                home
              </Link>
            </div>
