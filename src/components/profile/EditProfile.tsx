...
export const EditProfile = () => {
	...
	return (
		<>
			<Box image={`${urlLocalPath}/images/key.png`} title="Edit profile" description="Edit your profile information, such as your name and profile picture" action="" onClick={handleShow} />
